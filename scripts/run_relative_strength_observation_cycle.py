...
CYCLE_LOG = OBS_DIR / "relative_strength_observation_cycle_log.csv"

CYCLE_REPORT = REPORT_DIR / "relative_strength_observation_cycle_report.md"
STATUS_SNAPSHOT = REPORT_DIR / "relative_strength_observation_status_snapshot.md"
...
def main() -> None:
    observation_result = run_command(
        ...
        command=[
            ...
            "scripts/run_relative_strength_forward_observation_once.py",
        ],
        cwd=ROOT,
    )
    ...
    report = []
    report.append("# Relative Strength Observation Cycle Report")
    report.append("")
    ...
    snapshot = []
    snapshot.append("# Relative Strength Observation Status Snapshot")
    snapshot.append("")
    ...
    print("=== PHASE 28C OBSERVATION CYCLE COMPLETE ===")
